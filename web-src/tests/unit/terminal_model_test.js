...
describe('Test terminal model', function () {
    ...
    function normalizeStyledRanges(styleRanges) {
        const result = [];
        ...
        for (const styleRange of styleRanges) {
            if (!isNull(styleRange.style)) {
                ...
                if (isNull(styleRange.style.color)) {
                    delete styleRange.style.color
                }
            }
        }
    ...
    function assertStyles(actual, expected) {
        ...
        const normalizedActual = normalizeStyledRanges(actual);
        const normalizedExpected = normalizeStyledRanges(expected);
